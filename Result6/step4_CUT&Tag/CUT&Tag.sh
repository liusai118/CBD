patha=/home/liusai/Cut-tag/data/CBD_CUTTAG/CBD_DATA/clean_data
pathr=/home/liusai/Cut-tag/RESULT/12_20_CBD
path1=$patha
...
mkdir $path5
mkdir $path7
cat $patha/CBD.txt | while read id
  do
      mkdir $path2/${id}
      mkdir $path3/${id}
      mkdir $path5/${id}
      ...
      bowtie2 --end-to-end --very-sensitive --no-mixed --no-discordant --phred33 -I 10 -X 700 -p 10\
              -x /home/liusai/index/bowtie2/mouse/ncbi/GRCm39\
  ...
  # macs2 callpeak -t  ${path3}/${id}/${id}_bowtie2sort.bam -p 1e-5 -f BAMPE -g mm -n ${id} -B --outdir ${path5} > ${path3}/${id}/${id}.txt
