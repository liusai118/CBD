input=/home/liusai/RNA-seq/data/
output=/home/liusai/RNA-seq/result
mkdir -p $output/fastp
mkdir -p $output/sam
mkdir -p $output/bam
mkdir -p $output/FC

cat 2.txt | while read id
do
    ...
    hisat2 -t -p 32 -x /home/liusai/RNA-sequence/index/mmu \
...
featureCounts -T 10 -a /home/liusai/RNA-sequence/index/GCF_000001635.27_GRCm39_genomic.gtf -o read.count -p -t exon -g gene_id  *.bam
